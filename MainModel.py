...
# 1. VC Funding Trends in Hydrogen
...
# LEFT: Cumulative supply (baseline) — reuses blue_cum/green_cum 
...
# Your df_trade_det has: Year, From, To, Flow_kt, Distance_km, Mode, Unit_Cost
...
# "Run","Sector","H2 Price","Carbon $/t","Subsidy $/kg","IRR%","NPV $M" 
